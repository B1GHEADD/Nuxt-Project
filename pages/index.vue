    ...
    <div>
      <div class="mx-5 mt-36 lg:mx-24">
        ...
        <div class="flex flex-col font-bold">
          <span class="text-3xl mb-3 mt-3">Make Your House As </span>
        ...
        <div class="mt-2">
          <button class="bg-blue-500 w-44 p-4 rounded-md lg:mr-4">Primary Button</button>
          <button class="bg-blue-500 my-2 w-44 p-4 rounded-md">Secondary Button</button>
        </div>
      </div>
    </div>
  </main>
